...
function Violin({ addExp, addExpNotif }) {
    ...
    return (
        <>
            <Hero title="Violin Experience" subtitle={"June, 2007 - Present"} imageName={"lyceum-night.jpg"} height={"50vh"} />
            <div className="violin-content">
                ...
                <div className="violin-card">
                    <p className="paragraph-section">
                        ...
                        me into wanting to join the <span onClick={() => {
                            if (lyceumExp !== 0) {
                ...
                <div className="violin-card">
                    ...
                    <p className="paragraph-section">
                        ...
                        of me playing wih the Phil in December of 2016 with <span onClick={() => {
